/* PrismJS 1.29.0
https://prismjs.com/download.html#themes=prism-tomorrow&languages=markup+css+clike+javascript+typescript&plugins=line-numbers+highlight-keywords+data-uri-highlight+toolbar+copy-to-clipboard+match-braces */
      ...
      Prism.hooks.add("before-highlight", function (a) {
        if (i.pattern.test(a.code)) {
          for (var n in i.inside) {
            if (
              i.inside.hasOwnProperty(n) && !i.inside[n].inside &&
      ...
      if (d && "PRE" == d.tagName) {
        ...
        if (
          ...
          d.__listenerAdded || (d.addEventListener("mousedown", function () {
            ...
            Array.prototype.slice.call(e.querySelectorAll("." + t)).forEach(
              function (e) {
